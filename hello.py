                    ...
                    for FSP in f_span:
                        for FGH in f_ground_height:
                            for FUH in f_upper_height:
                                ...
                                print('Running on core'+ str(pid) + str(round(current_analysis/number_of_analysis*10000)/100) + '% at the moment |---| Record Number=' + str(record_no) + ' |---| Analysis ' + str(current_analysis) + ' of total ' + str(int(number_of_analysis)) + ' |---| Remaining Time=' + str(remaining_time/60/60) + 'hours' )
